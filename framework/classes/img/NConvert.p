###########################################################################
# $Id: NConvert.p,v 1.8 2011-12-30 05:59:01 misha Exp $
...
$result[^switch[$sAction]{
	^case[info]{^file::exec[$hScript.$sAction;$hOptions;^if($hParams.page){-page};^if($hParams.page){$hParams.page};-info;$hParams.sInput]}
	^case[convert]{^file::exec[$hScript.$sAction;$hOptions;-o;$hParams.sOutput;^if(^hParams.bRemoveMeta.int(0)){-rmeta}{-quiet};-out;$hParams.sFormat;-q;$hParams.iQuality;^if($hParams.iColors){-colors}{-quiet};^if($hParams.iColors){$hParams.iColors}{-quiet};^if($hParams.page){-page};^if($hParams.page){$hParams.page};$hParams.sInput]}
	...
	^case[crop]{^file::exec[$hScript.$sAction;$hOptions;-overwrite;-o;$hParams.sOutput;-crop;$hParams.iX;$hParams.iY;$hParams.iCropWidth;$hParams.iCropHeight;^if($hParams.bRemoveMeta){-rmeta}{-quiet};-out;$hParams.sFormat;-q;$hParams.iQuality;^if($hParams.iColors){-colors}{-quiet};^if($hParams.iColors){$hParams.iColors}{-quiet};$hParams.sInput]}
	^case[resize]{^file::exec[$hScript.$sAction;$hOptions;-overwrite;-o;$hParams.sOutput;-resize;$hParams.sWidth;$hParams.sHeight;^if($hParams.bKeepRatio){-ratio}{-quiet};^if(def $hParams.sFlag){-rflag}{-quiet};^if(def $hParams.sFlag){$hParams.sFlag}{-quiet};-out;$hParams.sFormat;-q;$hParams.iQuality;^if($hParams.iColors){-colors}{-quiet};^if($hParams.iColors){$hParams.iColors}{-quiet};^if($hParams.bRemoveMeta){-rmeta}{-quiet};-rtype;$hParams.sRType;^if($hParams.page){-page};^if($hParams.page){$hParams.page};$hParams.sInput]}
	^case[watermark]{^file::exec[$hScript.$sAction;$hOptions;-overwrite;-o;$hParams.sOutput;-wmfile;$hParams.sWMFile;-wmpos;^hParams.iX.int(0);^hParams.iY.int(0);^if(def $hParams.sPosition){-wmflag}{-quiet};^if(def $hParams.sPosition){$hParams.sPosition}{-quiet};^if($hParams.iOpacity){-wmopacity}{-quiet};^if($hParams.iOpacity){$hParams.iOpacity}{-quiet};^if($hParams.bRemoveMeta){-rmeta}{-quiet};-out;$hParams.sFormat;-q;$hParams.iQuality;$hParams.sInput]}
